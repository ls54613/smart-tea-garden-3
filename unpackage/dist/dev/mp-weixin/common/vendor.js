...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.getOpenId = getOpenId;exports.getOpenIdDetail = getOpenIdDetail;exports.add = add;exports.getAlarm = getAlarm;exports.nodeInfo = nodeInfo;exports.getIsFalse = getIsFalse;exports.getBasiclnfo = getBasiclnfo;exports.getcostProfit = getcostProfit;exports.getsalesvolume = getsalesvolume;exports.getprocurement = getprocurement;var _config = __webpack_require__(/*! ./config.js */ 58);
...
function getcostProfit() {
  return uni.request({
    url: "".concat(_config.baseUrl3, "/teaEnterpriseInfo/costAndProfitStatistics/18"),
    method: 'GET' });
...
function getsalesvolume() {
  return uni.request({
    url: "".concat(_config.baseUrl3, "/teaEnterpriseInfo/getYieldSalesTotal?id=18"),
    method: 'GET' });
...
function getprocurement() {
  return uni.request({
    url: "".concat(_config.baseUrl3, "/teaEnterpriseInfo/purchaseMonitor?id=18"),
    method: 'GET' });
